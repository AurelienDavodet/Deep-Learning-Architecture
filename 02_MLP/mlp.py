...
class MLP:
    def __init__(self, num_inputs: int, num_hidden: int, num_outputs: int, learning_rate: float = 0.1):
        """
        Initializes a multi-layer perceptron with one hidden layer.
    ...
    def sigmoid_derivative(self, x: np.ndarray) -> np.ndarray:
        ...
        Returns:
            np.ndarray: Element-wise derivative of sigmoid.
        """
        return x * (1 - x)
    ...
    def forward(self, inputs: np.ndarray) -> np.ndarray:
        ...
        Returns:
            np.ndarray: Final output of the network.
        """
    ...
    def backward(self, inputs: np.ndarray, expected_output: np.ndarray, output: np.ndarray) -> None:
        """
    ...
    def train(self, training_data: np.ndarray, labels: np.ndarray, epochs: int = 1000) -> None:
        """
